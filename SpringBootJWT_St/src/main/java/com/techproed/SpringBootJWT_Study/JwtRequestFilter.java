...
@Service//@Compenent annotation da kullanılabilir.
public class JwtRequestFilter extends OncePerRequestFilter {//Bu class client'den gelen request ile App'den gelen token compare(karsılastırma) methodu barındırır
